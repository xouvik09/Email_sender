...
def format_smtp_error(err):
    ...
    if "getaddrinfo failed" in err_str or "Name or service not known" in err_str:
        return f"Could not resolve SMTP server hostname. Please verify your host address."
...
class EmailRequestHandler(BaseHTTPRequestHandler):
    ...
    <div style="background: #0f172a; padding: 32px 24px; text-align: center; color: #ffffff;">
        ...
        <p style="margin: 8px 0 0; font-size: 14px; color: #94a3b8;">Discover the latest improvements and capabilities</p>
    </div>
    <div style="padding: 32px 28px; color: #334155; line-height: 1.65; font-size: 15px;">
        <p>Hello,</p>
        <p>We are excited to share several key enhancements designed to make your daily operations faster and more reliable.</p>
        <div style="margin: 24px 0; padding: 18px 20px; background: #f8fafc; border-left: 4px solid #0ea5e9; border-radius: 4px;">
            ...
            <ul style="margin: 8px 0 0; padding-left: 20px; color: #475569;">
                ...
                <li>Dual plain-text and rich HTML formatting</li>
                <li>Real-time recipient preview</li>
            </ul>
        </div>
        <div style="margin: 28px 0; text-align: center;">
            <a href="#" style="display: inline-block; background: #0f172a; color: #ffffff; padding: 12px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">Learn More</a>
        </div>
        <p style="font-size: 13px; color: #64748b; margin-top: 24px; border-top: 1px solid #f1f5f9; padding-top: 16px;">
            Have questions? Simply reply to this email to reach our team.
        </p>
    </div>
</div>""",
                    "text": "Hello,\n\nWe are excited to share several key enhancements designed to make your daily operations faster and more reliable.\n\nWhat's new:\n- Direct authenticated SMTP transmission\n- Dual plain-text and rich HTML formatting\n- Real-time recipient preview\n\nBest regards,\nThe Team",
                },
                {
                    "id": "meeting_followup",
                ...
                },
                {
                    ...
                    "name": "Welcome & Onboarding (HTML)",
                    "format": "html",
                    "subject": "Welcome to Our Platform!",
                    "html": """<div style="max-width: 600px; margin: auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 36px 32px; color: #1e293b;">
    <h2 style="margin-top: 0; color: #0f172a; font-size: 24px;">Welcome aboard!</h2>
    <p style="font-size: 15px; line-height: 1.6; color: #475569;">
        We are thrilled to have you with us. Your account is now active and ready for use.
    </p>
    <div style="margin: 28px 0; padding: 20px; background: #f8fafc; border-radius: 6px; border: 1px solid #e2e8f0;">
        <h4 style="margin: 0 0 10px; color: #0f172a;">Quick Start Guide</h4>
        <p style="margin: 0; font-size: 14px; color: #64748b; line-height: 1.5;">
            1. Access your dashboard<br>
            2. Configure your profile preferences<br>
            3. Explore our documentation
        </p>
    </div>
    <p style="font-size: 14px; color: #64748b; line-height: 1.5;">
        If you need any assistance getting started, our team is always here to help.
    </p>
</div>""",
...
if __name__ == "__main__":
    ...
    print(f"=========================================================")
    print(f" Dispatch Production Mail Server")
    print(f" Running at http://{host}:{port}")
    print(f" Ready for authenticated SMTP deliveries")
    print(f"=========================================================")
    try:
